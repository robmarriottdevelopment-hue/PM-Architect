...
export default function Home() {
  ...
  const handleAddTask = () => {
    ...
    addWorkItem({
      ...
      deliverable_id: project?.mode === 'STRUCTURED' ? project.selected_deliverable_id || null : null,
    });
  };
  ...
  return (
    <div className="flex flex-col h-screen bg-white text-slate-900 font-sans antialiased overflow-hidden">
        ...
        >
          <div className="w-80 h-full flex flex-col p-6">
            ...
            <div className="flex-1 overflow-auto" key={activeModule}>
              <ErrorBoundary name="Structural Panels">
                {activeModule === 'WBS' && (
            ...
            {project.mode === 'STRUCTURED' && project.active_view === 'ARCHITECTURE' ? (
              ...
              <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
                ...
                <div className="flex-1 px-12 pb-12 overflow-auto">
                  <ErrorBoundary name="Gantt Engine">
                    <GanttCanvas
                      items={items || []}
      ...
      <div className="fixed bottom-8 right-8 z-[100] flex flex-col items-end gap-4">
        {showAssistant && (
          <div className="w-80 bg-white border border-slate-200 rounded-3xl shadow-2xl p-6 mb-2 animate-fade-in relative overflow-hidden">
            ...
            <ErrorBoundary name="Structural Assistant">
              <StructuralAssistant />
            </ErrorBoundary>
          </div>
        )}
      ...
      {showReport && (
        <StatusReportModal onClose={() => setShowReport(false)} />
      )}
...
function StatusReportModalTrigger({ onOpen }: { onOpen: () => void }) {
  return (
    <button 
      onClick={onOpen}
      className="flex items-center gap-2 px-4 py-2 bg-slate-100 text-slate-900 rounded-xl text-xs font-bold hover:bg-slate-200 transition-all active:scale-95"
    >
